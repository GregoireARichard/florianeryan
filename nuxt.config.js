    ...
    vueI18n: {
      ...
      messages: {
        ...
        fr: {
          ...
          about_text1 : 'Bonjour, je m\'appelle Floriane Ryan ! Je touche principalement au design digital, et adore les processus de création dans de nombreux domaines (motion design, graphisme, 3D, écriture...).',
          about_text2 : 'Je vis actuellement à Paris, bien que je sois née à Philadelphie et y ai vécu les quatre premières années de ma vie. ',
          about_text3 : 'Si je ne suis pas en train de concevoir quelque chose, vous me trouverez en train de faire de cuisiner, de réserver des billets d\'avion, de prendre soin de mes plantes ou de découvrir un nouveau café avec des amis.',
          about_text4 : 'J\'adore rencontrer des gens fascinants du monde entier et j\'espère travailler dans de nombreuses destinations différentes au cours de ma vie.',
